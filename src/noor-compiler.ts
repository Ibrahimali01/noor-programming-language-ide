...
import { getFullIndexedLibraries } from './noor-data.ts';
...
export interface AutoLibInfo {
  stdlibName: string;
  keywords: string[];
  npmPackage?: string;
}

export const AUTO_LIBS: AutoLibInfo[] = [
  { stdlibName: 'std_express_server', keywords: ['خادم_سريع', 'إكسبريس', 'express', 'إنشاء_خادم_سريع'], npmPackage: 'express' },
  { stdlibName: 'std_socket_io', keywords: ['socket_io', 'socket.io', 'اتصال_مقبس_فوري', 'مقبس_فوري'], npmPackage: 'socket.io' },
  { stdlibName: 'std_fetch', keywords: ['جلب_ويب', 'fetch_api', 'طلب_ويب'], npmPackage: 'node-fetch' },
  { stdlibName: 'std_axios', keywords: ['أكسيوس', 'axios_get', 'axios_post'], npmPackage: 'axios' },
  { stdlibName: 'std_cheerio', keywords: ['تشيريو', 'cheerio', 'تحليل_html'], npmPackage: 'cheerio' },
  { stdlibName: 'std_puppeteer', keywords: ['بوبيتير', 'puppeteer', 'متصفح_تلقائي'], npmPackage: 'puppeteer' },
  { stdlibName: 'std_webrtc', keywords: ['ويب_ار_تي_سي', 'webrtc_stream', 'بث_مباشر_شاشة'], npmPackage: 'wrtc' },
  { stdlibName: 'std_grpc', keywords: ['جي_ار_بي_سي', 'grpc_client', 'اتصال_grpc_سريع'], npmPackage: '@grpc/grpc-js' },
  { stdlibName: 'std_soap', keywords: ['سواب_خدمة', 'soap_client', 'خدمات_قديمة_soap'], npmPackage: 'soap' },
  { stdlibName: 'std_mqtt', keywords: ['ام_كيو_تي_تي', 'mqtt_publish', 'بروتوكول_mqtt'], npmPackage: 'mqtt' },
  { stdlibName: 'std_amqp', keywords: ['ام_كيو_بي_بلي', 'amqp_consume', 'طابور_أرانب'], npmPackage: 'amqplib' },
  { stdlibName: 'std_ipfs', keywords: ['اي_بي_اف_اس', 'ipfs_add', 'مجلد_لامركزي'], npmPackage: 'ipfs-http-client' },
  { stdlibName: 'std_web3', keywords: ['ويب3', 'web3_contract', 'محفظة_تشفير'], npmPackage: 'web3' },
  { stdlibName: 'std_paypal', keywords: ['بايبال', 'paypal_payment', 'بوابة_دفع_بايبال'], npmPackage: '@paypal/checkout-server-sdk' },
  { stdlibName: 'std_twilio', keywords: ['تويليو', 'twilio_sms', 'إرسال_رسالة_sms'], npmPackage: 'twilio' },
  { stdlibName: 'std_sendgrid', keywords: ['سيند_جريد', 'sendgrid_email', 'ايميل_نشرة'], npmPackage: '@sendgrid/mail' },
  { stdlibName: 'std_cloudflare', keywords: ['كلاود_فلير', 'cloudflare_dns', 'حماية_كلاود_فلير'], npmPackage: 'cloudflare' },
  { stdlibName: 'std_tensorflow', keywords: ['تنسور_فلو', 'tensorflow', 'تعلم_آلة_عميق'], npmPackage: '@tensorflow/tfjs' },
  { stdlibName: 'std_pytorch', keywords: ['باي_تورتش', 'pytorch', 'تعلم_عميق_بي'], npmPackage: 'onnxruntime-node' },
  { stdlibName: 'std_opencv', keywords: ['رؤية_حاسوبية', 'opencv', 'معالجة_صور_كاش'], npmPackage: '@techstark/opencv-js' },
  { stdlibName: 'std_pandas', keywords: ['بانداز', 'pandas', 'إطار_بيانات'], npmPackage: 'danfojs-node' },
  { stdlibName: 'std_numpy', keywords: ['نامباي', 'numpy', 'مصفوفة_رقمية'], npmPackage: 'numjs' },
  { stdlibName: 'std_keras', keywords: ['كيراس', 'keras_model', 'شبكة_عصبية'], npmPackage: '@tensorflow/tfjs' },
  { stdlibName: 'std_scikit_learn', keywords: ['سايكت_ليرن', 'scikit', 'توقع_منحنى'], npmPackage: 'ml-regression' },
  { stdlibName: 'std_nltk', keywords: ['تحليل_لغوي_nltk', 'nltk_tokenizer'], npmPackage: 'natural' },
  { stdlibName: 'std_spacy', keywords: ['سبيسي', 'spacy_ner', 'ذكاء_لغوي'], npmPackage: 'natural' },
  { stdlibName: 'std_redis', keywords: ['ريدس_كاش', 'redis_store', 'خادم_كاش'], npmPackage: 'redis' },
  { stdlibName: 'std_mongoose', keywords: ['مونغوس_موديل', 'mongoose_connect', 'اتصال_مونغو'], npmPackage: 'mongoose' },
  { stdlibName: 'std_prisma', keywords: ['بريزما_رابط', 'prisma_query', 'عميل_بريزما'], npmPackage: '@prisma/client' },
  { stdlibName: 'std_sequelize', keywords: ['سيكولايز_موديل', 'sequelize_sync', 'مربط_سيكولايز'], npmPackage: 'sequelize' },
  { stdlibName: 'std_firebase', keywords: ['اتصال_فايربيز', 'firebase_auth', 'قاعدة_فايربيز'], npmPackage: 'firebase-admin' },
  { stdlibName: 'std_supabase', keywords: ['اتصال_سوبابيز', 'supabase_auth', 'قاعدة_سوبابيز'], npmPackage: '@supabase/supabase-js' },
  { stdlibName: 'std_auth0', keywords: ['توثيق_اوث_زيرو', 'auth0_login'], npmPackage: 'auth0' },
  { stdlibName: 'std_base64', keywords: ['ترميز_باز64', 'فك_ترميز_باز64'] },
  { stdlibName: 'std_hash', keywords: ['هاش_md5', 'هاش_sha256'] },
  { stdlibName: 'std_web_scraper', keywords: ['استخراج_النصوص', 'كشط_موقع'] },
  { stdlibName: 'std_docker', keywords: ['دوكر_حالة_حاويات'] },
  { stdlibName: 'std_network_scan', keywords: ['بينج_خادم', 'فحص_شبكة'] },
  { stdlibName: 'std_jwt', keywords: ['إنشاء_توكن', 'تحقق_توكن'] },
  { stdlibName: 'std_websocket', keywords: ['اتصال_مقبس', 'منشئ_مقبس'] },
  { stdlibName: 'std_sqlite', keywords: ['استعلام_اس_كيو_لايت'] },
  { stdlibName: 'std_git', keywords: ['تحديث_جيت'] },
  { stdlibName: 'std_audio', keywords: ['تشغيل_صوت'] },
  { stdlibName: 'std_email', keywords: ['ارسال_ايميل'] }
];
...
export class NoorInterpreter {
  ...
  private setupGlobals() {
    ...
    this.globalEnv.define('تحميل_مكتبة', (args: any[]) => {
      let libPath = args[0] || '';
      const isSilent = args[1] === true || args[1] === 'صحيح' || args[1] === 'true';
      ...
      let code = '';
      if (typeof window === 'undefined') {
        const foundAuto = AUTO_LIBS.find(lbl => lbl.stdlibName === libName || lbl.stdlibName.replace('std_', '') === libName);
        if (foundAuto && foundAuto.npmPackage) {
          try {
            getNoorRequire().resolve(foundAuto.npmPackage);
          } catch(e) {
            if (!isSilent) {
              this.consoleLogs.push(`📦 [نظام الحزم] تم كشف استخدام مكتبة "${libName}" التي تتطلب حزمة NPM حقيقية (${foundAuto.npmPackage})...`);
              this.consoleLogs.push(`⚡ جاري تنزيل وتثبيت الحزمة تلقائياً في الخلفية لتهيئة واجهة الاتصالات الفورية...`);
            }
            try {
              const { execSync } = getNoorRequire()('child_process');
              execSync(`npm install --no-save ${foundAuto.npmPackage}`, { stdio: 'ignore' });
              this.consoleLogs.push(`✅ تم تثبيت اعتماد "${foundAuto.npmPackage}" للشبكات بنجاح!`);
            } catch(installErr: any) {
              this.consoleLogs.push(`⚠️ تعذر تفعيل التثبيت الآلي للاعتماد: ${installErr.message}`);
            }
          }
        }
        try {
...
<body>
  ...
  <script>
    ...
    this.globalEnv.define('رسم_مجسم', (args: any[]) => {
      const name = args[0] || 'كائن';
      
      let type = 'مكعب';
      let color = 'رمادي';
      let x = 0, y = 1, z = 0;
      
      if (name.includes('بطل') || name.includes('لاعب') || name.includes('مقاتل') || name.includes('شخصية')) {
        type = 'لاعب';
        color = 'أخضر';
        y = 1;
      } else if (name.includes('ارض') || name.includes('أرض') || name.includes('ساحة') || name.includes('ملعب') || name.includes('عشب')) {
        type = 'أرضية';
        color = 'عشب';
        y = 0;
      } else if (name.includes('مبنى') || name.includes('جدار') || name.includes('جدران')) {
        type = 'مبنى';
        color = 'رمادي';
      } else if (name.includes('كرة') || name.includes('كورة')) {
        type = 'كرة';
        color = 'أحمر';
        y = 1;
      } else if (name.includes('دخان') || name.includes('جزيئات') || name.includes('نار')) {
        type = 'جزيئات';
        color = 'أصفر';
      } else if (name.includes('سيارة') || name.includes('مركبة') || name.includes('car')) {
        type = 'سيارة';
        color = 'أحمر';
        y = 1;
      }

      // Dynamic coordinate support (e.g., رسم_مجسم("بطل", 15, 2, -10))
      if (typeof args[1] === 'number') {
        x = args[1];
        if (typeof args[2] === 'number') y = args[2];
        if (typeof args[3] === 'number') z = args[3];
        ...
        const posStr = args[1];
        if (posStr.includes('يمين')) x = 15;
        if (posStr.includes('يسار')) x = -15;
        if (posStr.includes('أمام') || posStr.includes('امام') || posStr.includes('فوق')) z = 15;
        if (posStr.includes('خلف') || posStr.includes('وراء') || posStr.includes('تحت')) z = -15;
        if (posStr.includes('أعلى') || posStr.includes('اعلى')) y = 8;
        if (posStr.includes('أسفل') || posStr.includes('اسفل')) y = 0.5;
      }
      ...
      const entity = {
        ...
        'اسم': name,
        'س': x, 'ص': y, 'ع': z,
        'كتلة': type === 'أرضية' || type === 'مبنى' ? 0 : 1.5,
        'لون': color
      };
      
      this.publishedWorldData.entities.push(entity);
      this.consoleLogs.push(`👾 [ألعاب 3D] رسم كائن 3D "${name}" من النوع "${type}" في الإحداثيات (${x}, ${y}, ${z}).`);
      return entity;
    });
    ...
    this.globalEnv.define('نوة_كيانات_ومكونات', (args: any[]) => {
      ...
      const ecs = { entities: [], systems: [] };
      this.publishedWorldData.ecsInstance = ecs;
      return ecs;
    });
    ...
    this.globalEnv.define('توليد_ساحة_معركة_عشوائية', (args: any[]) => {
      const ecs = args[0] || { entities: [] };
      
      this.consoleLogs.push(`🗺️ [ECS] جارٍ التوليد التلقائي لساحة معارك ببجي المصغرة والذكية...`);
      ...
      this.consoleLogs.push(`🌍 [ECS] تم توليد الكيان: تضاريس خريطة إرانغل المصغرة (Entity ID: ${mapId}).`);

      // 2. Create Safe Zone
      const zoneId = Math.random().toString(36).substring(7);
      const zoneEntity = {
        id: zoneId,
        components: {
      ...
      this.consoleLogs.push(`⭕ [ECS] تم توليد الكيان: المنطقة الآمنة / الزون الأول (Entity ID: ${zoneId}).`);

      // 3. Random Landmarks / Cities
      const landmarks = ["المطار", "المدرسة", "بوشنكي", "الميناء", "الحاويات", "المستشفى", "ياسنايا"];
      
      landmarks.forEach((name) => {
        const x = Math.floor(Math.random() * 8000) + 1000;
        const y = Math.floor(Math.random() * 8000) + 1000;
        const landmarkId = Math.random().toString(36).substring(7);
        const entity = {
          id: landmarkId,
          components: {
        ...
        ecs.entities.push(entity);
        this.consoleLogs.push(`🏢 [ECS] تم توليد مَعلم رئيسي: مدينة "${name}" في الموقع (${x}، ${y}) (Entity ID: ${landmarkId}).`);
      });

      // 4. Random Buildings
      const buildings = ["مستودع أسلحة لوجستي", "برج مراقبة عسكري", "منزل سكني طابقين", "مخبأ ذخائر خرساني"];
      for (let i = 0; i < 10; i++) {
        const name = buildings[Math.floor(Math.random() * buildings.length)] + ` #${i+1}`;
        const x = Math.floor(Math.random() * 8000) + 1000;
        const y = Math.floor(Math.random() * 8000) + 1000;
        ...
        ecs.entities.push(entity);
        this.consoleLogs.push(`🏠 [ECS] تم زرع كيان مبنى: "${name}" عشوائياً في الإحداثيات (${x}، ${y}).`);
      }

      // 5. Random Vehicles
      const vehicles = ["جيب_UAZ", "دراجة نارية خفيفة", "سيارة سيدان طائرة", "عربة باجي تكتيكية"];
      for (let i = 0; i < 5; i++) {
        ...
        ecs.entities.push(entity);
        this.consoleLogs.push(`🚙 [ECS] تم نشر مركبة عشوائية قابلة للقيادة: "${type}" في الإحداثيات (${x}، ${y}).`);
      }
      ...
      for (let i = 0; i < 4; i++) {
        ...
        ecs.entities.push(entity);
        this.consoleLogs.push(`🪖 [ECS] تم توليد خصم نشط عشوائياً: "خصم_مستهدف #${i+1}" في الموقع (${x}، ${y}).`);
      }

      this.consoleLogs.push(`🎉 [ECS] تم التوليد التلقائي لساحة المعركة العشوائية بنجاح! تحتوي الآن على ${ecs.entities.length} كيانات ECS تفاعلية.`);
      return true;
    });
    ...
    this.globalEnv.define('التحكم_بالأبعاد', (args: any[]) => {
      const entity = args[0];
      const x = args[1] !== undefined ? args[1] : 1;
      const y = args[2] !== undefined ? args[2] : 1;
      const z = args[3] !== undefined ? args[3] : 1;
      if (entity && typeof entity === 'object') {
        entity['العرض'] = x;
        entity['الارتفاع'] = y;
        entity['الطول'] = z;
      }
      this.consoleLogs.push(`📏 [Dimensions] تحديد السُمك والأبعاد والطول - X:${x}, Y:${y}, Z:${z}`);
      return true;
    });
  ...
  public run(source: string, isDebug = false): { success: boolean; logs: string[]; error?: string } {
    ...
    // 🔍 نظام استكشاف واستدعاء المكاتب ذكياً (Noor Smart Autoloader & Dependency Installer)
    let autoPrepends = '';
    const srcLines = source.split('\n');
    try {
      const allLibs = getFullIndexedLibraries() || [];
      for (const lib of allLibs) {
        if (lib.name === 'core') continue;
        const hasKeyword = srcLines.some(line => {
          const trimmed = line.trim();
          if (trimmed.startsWith('#')) return false; // تجاهل التعليقات بالكامل
          return lib.keywords.some(kw => {
            const escapedKw = kw.replace(/[-\/\\^$*+?.()|[\]{}]/g, '\\$&');
            // مطابقة دقيقة للاسم البرميحي بدون تداخل
            const regex = new RegExp(`(?:^|[^\\p{L}\\p{M}\\p{N}_])${escapedKw}(?:$|[^\\p{L}\\p{M}\\p{N}_])`, 'u');
            return regex.test(trimmed);
          });
        });
        if (hasKeyword) {
          const stdName = lib.name;
          const shortName = stdName.startsWith('std_') ? stdName.replace('std_', '') : stdName;
          const alreadyLoaded = source.includes(`"stdlib/${stdName}"`) || 
                                source.includes(`'stdlib/${stdName}'`) ||
                                source.includes(`"${stdName}"`) ||
                                source.includes(`'${stdName}'`) ||
                                source.includes(`"stdlib/${shortName}"`) ||
                                source.includes(`'stdlib/${shortName}'`) ||
                                source.includes(`"${shortName}"`) ||
                                source.includes(`'${shortName}'`);
          if (!alreadyLoaded) {
            // تحميل تلقائي صامت بالكامل بدون طباعة في واجهة الأوامر CLI
            autoPrepends += `تحميل_مكتبة("stdlib/${stdName}", صحيح)\n`;
          }
        }
      }
    } catch (e) {
      // Fallback to legacy AUTO_LIBS if dynamic indexing fails
      for (const lib of AUTO_LIBS) {
        const hasKeyword = srcLines.some(line => {
          const trimmed = line.trim();
          if (trimmed.startsWith('#')) return false;
          return lib.keywords.some(kw => trimmed.includes(kw));
        });
        if (hasKeyword) {
          const alreadyLoaded = source.includes(`"${lib.stdlibName}"`) || source.includes(`'${lib.stdlibName}'`);
          if (!alreadyLoaded) {
            autoPrepends += `تحميل_مكتبة("${lib.stdlibName}", صحيح)\n`;
          }
        }
      }
    }
...
// 📖 أداة المترجم البرمجية لتوليد وثائق برمجية تفاعلية وحية لكافة مكتبات النظام
export function generateLiveDocs(): any[] {
  try {
    const fs = typeof window === 'undefined' ? getNoorRequire()('fs') : null;
    const path = typeof window === 'undefined' ? getNoorRequire()('path') : null;
    
    if (!fs || !path) {
      return [];
    }
    
    const stdFolder = path.join(process.cwd(), 'stdlib');
    if (!fs.existsSync(stdFolder)) {
      return [];
    }
    
    const files = fs.readdirSync(stdFolder).filter((f: string) => f.endsWith('.noor'));
    const docList = files.map((file: string) => {
      const p = path.join(stdFolder, file);
      const content = fs.readFileSync(p, 'utf8');
      const lines = content.split('\n');
      
      // استخراج الاسم البصري والوصف الأساسي من التعليقات الأولى
      let displayName = file.replace('.noor', '').replace('std_', '').replace('_', ' ');
      let description = '';
      ...
      if (commentLines.length > 0) {
        displayName = commentLines[0];
        description = commentLines.slice(1).join('\n');
      }
      
      // استخراج الدوال البرمجية ومعاملات الاستدعاء
      const functions: any[] = [];
      const keywords: string[] = [];
      for (let i = 0; i < lines.length; i++) {
        const line = lines[i].trim();
        // مطابقة Unicode كاملة للأحرف العربية واللاتينية والأرقام
        const m = line.match(/دالة\s+([\p{L}\p{M}\p{N}_]+)\s*\(([^)]*)\)/u);
        if (m) {
          const name = m[1];
          const rawParams = m[2];
          const params = rawParams.split(',').map(x => x.trim()).filter(Boolean);
          
          let funcDesc = '';
          if (i > 0) {
            const prevLine = lines[i - 1].trim();
            if (prevLine.startsWith('#')) {
              funcDesc = prevLine.slice(1).trim();
            }
          }
          functions.push({
            name,
            params,
            description: funcDesc || `دالة تنفيذية في مكتبة ${displayName}`
          });
          keywords.push(name);
        }
      }
      
      let classification = 'مكتبة عامة / General Library';
      const fLower = file.toLowerCase();
      if (/game|audio|color|graphic|layout|three|canvas/i.test(fLower)) {
        classification = 'ألعاب ورسوميات / Games & Graphics';
      } else if (/ai|ml|neural|nlp|chatbot|vision|deep|tensorflow|pytorch/i.test(fLower)) {
        classification = 'ذكاء اصطناعي / Artificial Intelligence';
      } else if (/db|sql|redis|mongo|postgres|cassandra|neo4j|elastic|prisma/i.test(fLower)) {
        classification = 'قواعد بيانات / Databases';
      } else if (/aws|cloud|azure|gcp|server|http|express|socket|net|network/i.test(fLower)) {
        classification = 'خوادم وشبكات / Servers & Networks';
      } else if (/crypto|security|hash|jwt|auth|firewall|guard/i.test(fLower)) {
        classification = 'أمن وتشفير / Security & Cryptography';
      } else if (/os|fs|process|system|zip|daemon|terminal|file/i.test(fLower)) {
        classification = 'نظام وأتمتة / OS & Automation';
      }
      
      return {
        fileName: file,
        libraryName: file.replace('.noor', ''),
        displayName,
        classification,
        description: description || `مكتبة مدمجة بلغة نور لتوفير حلول برمجية متقدمة في مجال ${classification}`,
        functions,
        keywords: keywords.length > 0 ? keywords : [file.replace('.noor', '')]
      };
    });
    return docList;
  } catch (e) {
    console.warn("[LIVE DOCGEN ERROR] Failed to parse stdlib on filesystem:", e);
    return [];
  }
}
